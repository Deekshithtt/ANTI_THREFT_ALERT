#define BLYNK_TEMPLATE_ID "TMPL35qT6ItIF"
#define BLYNK_TEMPLATE_NAME "Theft Alert Notification"
#define BLYNK_AUTH_TOKEN "JwYZl3qpPd3r0Z0DQWz9p0otyWOLKn4o"
...
void notifyOnTheft()
{
  ...
  if (isTheftAlert==1) {
    ...
    Blynk.logEvent("theft_s","Theft Alert in Home");
//    flag=1;
  }
